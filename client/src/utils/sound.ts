...
class SoundEffects {
  ...
  // Card swoosh / whoosh on drop/play
  ...
  // Coin collect / Giftcode reward chime
  ...
  // Coin transfer whoosh / ping
  public playCoinTransfer() {
    const ctx = this.getContext();
    if (!ctx) return;
